                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: AbhayaLibreBold.copyWith(
                                  color: AppColors.APP_COLOR, fontSize: 18),
                            ),
                          ],
                        ),
                        // const Divider(
                            ...
                            Text(
                              AppUtils.appUser?.smartblePlanInfo.expireAt !=
                                  ...
                                  ? DateFormat('yyyy-MM-dd').format(
                                      DateTime.parse(AppUtils
                                          .appUser!.smartblePlanInfo.expireAt!))
                                  : '',
                              style: AbhayaLibreBold.copyWith(
                                  color: AppColors.APP_COLOR, fontSize: 18),
                            ),
                          ...
                          children: [
                            ...
                            Text(
                              AppUtils.appUser?.followerPlanInfo.expireAt !=
                                  ...
                                  ? DateFormat('yyyy-MM-dd').format(
                                      DateTime.parse(AppUtils
                                          .appUser!.followerPlanInfo.expireAt!))
                                  : '',
                              style: AbhayaLibreBold.copyWith(
                                  color: AppColors.APP_COLOR, fontSize: 18),
                            ),
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              AppUtils.appUser!.whatsappService.remaining
                                  .toString(),
                              style: AbhayaLibreBold.copyWith(
                                  color: AppColors.APP_COLOR, fontSize: 18),
                            ),
