...
class RegionLanguage extends StatelessWidget {
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              const AppNavBar(imagePath: Images.ARROW_BACK, headerTxt: "zone"),
              SizedBox(
                height: 30,
              ),
              Padding(
                padding: EdgeInsets.symmetric(horizontal: 16),
                child: Text(
                  "إعداد المنطقة الزمنية الصحيحة مهم لوصول إشعاراتك في الوقت الصحيح.",
