...
class GetStudentCalssUseCase extends BaseUseCase {
  GetStudentCalssUseCase({required super.repo, required super.db});
  Future<Either<Failure, PageinationModel<StudentInfo>>> call(
          BaseEnity entity) =>
      repo.calling(db: db.filterstudents, entity: entity);
}
