...
class GetStudentsBehavoir extends BaseUseCase {
  GetStudentsBehavoir({required super.repo, required super.db});
  Future<Either<Failure, PageinationModel<StudentBehavior>>> call(
          BaseEnity entity) =>
      repo.calling(db: db.filterbehavoir, entity: entity);
}
